      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid md:grid-cols-4 gap-6">
          <div>
            ...
            <p className="text-[#6c757d] text-sm">Comprehensive infrastructure tools for diagnostics, monitoring, and digital reliability.</p>
          </div>
          <div>
            <h4 className="text-[#212529] font-semibold mb-3 text-sm">Popular Tools</h4>
            <ul className="space-y-2 text-sm text-[#6c757d]">
              <li><button onClick={() => handleToolNavigation('/blacklist-check')} className="hover:text-[#0d6efd] transition-colors">Blacklist Check</button></li>
              <li><button onClick={() => handleToolNavigation('/mx-record')} className="hover:text-[#0d6efd] transition-colors">MX Lookup</button></li>
              <li><button onClick={() => handleToolNavigation('/ping-test')} className="hover:text-[#0d6efd] transition-colors">Ping Test</button></li>
              <li><button onClick={() => handleToolNavigation('/whois-lookup')} className="hover:text-[#0d6efd] transition-colors">WHOIS</button></li>
            </ul>
          </div>
          <div>
